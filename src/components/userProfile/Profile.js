  ...
  if (customer) {
    return (
      <div class="detailsItem">
        <img className='detailsImage' src='https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fcdn.onlinewebfonts.com%2Fsvg%2Fimg_24787.png&f=1&nofb=1' alt="silhouette"/>
        <h1>
